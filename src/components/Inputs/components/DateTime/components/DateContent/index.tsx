...
export function DateContent({ shownDate, selectedDate, onChange, onChangeViewDate }: DateContentProps) {
  ...
  return (
    <div onClick={handleClick} className="max-w-[400px] bg-white dark:bg-yankeesBlue-400 flex items-center justify-center shadow-lg rounded-lg w-full flex-col absolute left-0 top-[120%] p-5 z-10 cursor-default">
